...
PRIORITY_INDEX = 2
COST_INDEX = 3
PERCENTAGE_COMPLETED_INDEX = 4


def main():
    """It's the main function of the project."""
...
def load_projects(file_name):
    """To load the date from the txt file and store it in a list."""
    projects = []
    with open(file_name) as in_file:
        ...
        for line in in_file:
            ...
            percent_complete = int(parts[PERCENTAGE_COMPLETED_INDEX])
...
def save_projects(file_name, projects):
    """To save all the data from the list to the txt file"""
...
def determine_incomplete_complete(projects):
    """To determine which project is completed or uncompleted."""
    incomplete_projects = []
    completed_projects = []
    for project in projects:
...
def filter_projects_by_date(projects, date):
    """To filter the project list by the date"""
